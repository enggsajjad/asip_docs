...
\begin{longtable}[]{@{}ll@{}}
\toprule
\textbf{Setting} & \textbf{Explanation}\tabularnewline
\midrule
\endhead
PROJECT\_NAME = browstd32 & This is the name of your project directory
(``\emph{browstd32}'' in \protect\hyperlink{Fig21}{Figure 2-1} or for
example ``\emph{AnotherProject}'' in \protect\hyperlink{Fig23}{Figure
2-3}). Whenever you create a new project with a new directory, then you
have to adapt this parameter.\tabularnewline
CPU\_NAME = browstd32 & This is the name of the ASIP Meister project
file (``\emph{browstd32.pdb}'' in \protect\hyperlink{Fig23}{Figure
2-3}). As the names of subdirectories inside the ``\emph{meister}''
...
project directory.\tabularnewline
...
modified version.\tabularnewline
...
result with an application, as explained in Chapter~6.4.\tabularnewline
\vtop{\hbox{\strut ASIPMEISTER\_PROJECTS\_}\hbox{\strut DIR =
...
explained in \protect\hyperlink{Fig21}{Figure 2-1}.\tabularnewline
...
settings for the project name, as mentioned above.\tabularnewline
...
explained in \protect\hyperlink{Fig22}{Figure 2-2}, the created
``\emph{TestData.DM}'' \& ``\emph{TestData.IM}'' will automatically be
copied to this directory.\tabularnewline
