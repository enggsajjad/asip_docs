...
// Generated by ASIP Meister 2.3 on 2019/01/30 16:29:32 
Design{
Version{"2.3"},
...
"OP-code"{"name"{"func"},width{"11","6"}},
"OP-code"{"name"{"ope"},width{"5","0"}}
}
}}}},
...
"OP-code"{"binary"{"00010"},width{"10","6"}},
"OP-code"{"binary"{"000000"},width{"5","0"}}
},"STEP2"{type{"RR2"},"Operand"{"name"{"rd"},width{"31","27"}},
"Operand"{"name"{"rs1"},width{"26","22"}},
"OP-code"{"binary"{"0000011100000000110001"},width{"21","0"}}
},"STEP5"{type{"RR2"},"Operand"{"name"{"rd"},width{"31","27"}},
"Operand"{"name"{"rs1"},width{"26","22"}},
"OP-code"{"binary"{"0000011100000000110010"},width{"21","0"}}
},"STEP4a"{type{"RR"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rd"},width{"21","17"}},
"OP-code"{"binary"{"111"},width{"16","14"}},
"OP-code"{"binary"{"10000001"},width{"13","6"}},
"OP-code"{"binary"{"000001"},width{"5","0"}}
},"STEP4b"{type{"RR3"},"Operand"{"name"{"rs1"},width{"31","27"}},
"Operand"{"name"{"rs2"},width{"26","22"}},
"Operand"{"name"{"rs3"},width{"21","17"}},
"Operand"{"name"{"rd"},width{"16","12"}},
"OP-code"{"binary"{"111111"},width{"11","6"}},
"OP-code"{"binary"{"111101"},width{"5","0"}}
}}},
...
bit_width{"16"},
bit_width_out{"32"}}}
,"newADDER1"{class{"adder"},classpath{"/basicfhmdb/computational/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
algorithm{"default"}}}
,"newADDER2"{class{"adder"},classpath{"/basicfhmdb/computational/"},use{"(unspecified)"},
parameter{
abstraction_level{for_simulation{"Behavior"},for_synthesis{"Gate"}},
bit_width{"32"},
algorithm{"default"}}}
...
,"STEP2"{variable{"wire check_negative;
wire [31:0] resultO;
wire [31:0] output;
wire [31:0] ZERO;
wire [31:0] yes88;
...
check_negative = source1[31]; 											//twos complement, 32nd bit = 1 if negative
...
one = '1';
   DOWNLIMIT = \"11111111111111111000000000000000\";
     UPLIMIT = \"00000000000000000111111111111111\";			//ON BOTH LIMITS I NEED TO COMPARE THE BIG PART 
...
//aux1 = bit0 | bit1; 		//WE SHOULDNT CHECK THE SIGN BIT
aux2 = bit1 | bit2;
aux3 = aux2 | bit3;
aux4 = aux3 | bit4;
aux5 = aux4 | bit5;
...
//n_aux1 = bit0 & bit1; 		//WE SHOULDNT CHECK THE SIGN BIT
n_aux2 = bit1 & bit2;
n_aux3 = n_aux2 & bit3;
n_aux4 = n_aux3 & bit4;
n_aux5 = n_aux4 & bit5;
...
,"STEP4a"{variable{"wire [31:0] output;
...
wire triple_adder_zero;"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
wire [31:0]  fetch_inst;                                    // opecode
wire         fetch_addrerr;                                 // address err. from IM
wire [31:0]  fetch_status_data;
...
source1  = FWU0.forward(rs1, gpr_double_read_stmp1);
source2  = FWU1.forward(rs2, gpr_double_read_stmp2);"},
clk(3){"ZERO = \"00000000000000000000000000000000\";
zero = '0';
 one = '1';
 s1bit0 = source1[0];
 s1bit1 = source1[1];
...
//STEP 1													//WE ASSIGN THE INITIAL VALUE (>>3)
initial_value = shifted3;


//STEP 2													// WE CHECK IF THE REQUESTED BITS ARE ON
check4 = source2[2];
check2 = source2[1];
check1 = source2[0];

//STEP3														//IF NOT ON THE SHIFTED VALUE BECOMES 0
checkedvalue4 = (check4) ? shifted0 : ZERO;
checkedvalue2 = (check2) ? shifted1 : ZERO;
checkedvalue1 = (check1) ? shifted2 : ZERO;

//STEP4														// TRIPLE ADD ON THE CHECKED VALUES AND ADDED TO THE INITIAL
triple_adder_zero = '0';
...
,"STEP4b"{variable{"wire [3:0]   alu_flag;
wire [31:0] added;
wire [31:0] subbed;
...
wire [31:0]  source1;
wire [31:0]  source2;
wire [31:0]  source3;"},clk(1){"wire [31:0]  fetch_current_pc;                              // current pc
wire [31:0]  fetch_inst;                                    // opecode
wire         fetch_addrerr;                                 // address err. from IM
wire [31:0]  fetch_status_data;
...
clk(3){"//<inverted_source1, alu_flag> = ALU.not(source1);
zero = '0';
c1_source1 = ~source1;
