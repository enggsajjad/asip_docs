...
-- Generated by ASIP Meister 2.3 on 2019/02/04 13:20:36 
----------------------------------------------------------------------
...
entity rtg_controller is
  port (
    ...
    CTRLOUT_UA_MUX05_SEL : out std_logic_vector(2 downto 0);
    ...
    CTRLOUT_UA_MUX13_SEL : out std_logic_vector(2 downto 0);
    ...
    CTRLOUT_UA_MUX24_SEL : out std_logic_vector(2 downto 0);
...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w54;
  ...
  signal decout_UA_MUX05_SEL : std_logic_vector(2 downto 0);
  ...
  signal decout_UA_MUX13_SEL : std_logic_vector(2 downto 0);
  ...
  signal decout_UA_MUX24_SEL : std_logic_vector(2 downto 0);
  signal decout_UA_MUX25_SEL : std_logic_vector(1 downto 0);
  signal decout_UA_MUX26_SEL : std_logic;
  signal decout_ctrl_word_ID : std_logic_vector(72 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(53 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(53 downto 0);
  ...
  signal resctrl_UA_MUX05_SEL_inst : std_logic_vector(2 downto 0);
  ...
  signal resctrl_UA_MUX13_SEL_inst : std_logic_vector(2 downto 0);
  ...
  signal resctrl_UA_MUX24_SEL_inst : std_logic_vector(2 downto 0);
...
begin
  ...
  decout_ctrl_word_ID(69 downto 68) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ANDI =
  	'1' or decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ENEQ = '1' or
  	decoded_LB = '1' or decoded_LW = '1' or decoded_ORI = '1' or decoded_SB
  ...
  decout_ctrl_word_ID(67 downto 66) <= 
	...
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_BRNZ =
  	...
  	decoded_SUBI = '1' or decoded_SW = '1' else
	"00" when decoded_ADD = '1' or decoded_EEQ = '1' or decoded_ELT = '1'
  	or decoded_ENEQ = '1' or decoded_SUB = '1' else
	"00";
  -- UA_MUX04.SEL:
  decout_ctrl_word_ID(65 downto 65) <= 
	"1" when decoded_ARSI = '1' or decoded_LLSI = '1' else 
	"0" when decoded_ARS = '1' or decoded_LLS = '1' else 
	"0";
  -- UA_MUX08.SEL:
  decout_ctrl_word_ID(64 downto 63) <= 
	"10" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
	...
	"01" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	...
  	decoded_LLSI = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
  	decoded_ORI = '1' or decoded_SUBI = '1' else
	"00" when decoded_ADD = '1' or decoded_ARS = '1' or decoded_EEQ = '1'
  	or decoded_ELT = '1' or decoded_ENEQ = '1' or decoded_LLS = '1' or
  	decoded_MOD = '1' or decoded_SUB = '1' else
	"00";
  -- UA_MUX10.SEL:
  decout_ctrl_word_ID(62 downto 62) <= 
	"1" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LLSI = '1' or decoded_LSOI = '1' or decoded_ORI = '1' or
  	decoded_SUBI = '1' else
	"0" when decoded_ADD = '1' or decoded_ARS = '1' or decoded_EEQ = '1'
  	or decoded_ELT = '1' or decoded_ENEQ = '1' or decoded_LLS = '1' or
  	decoded_MOD = '1' or decoded_SUB = '1' else
	"0";
  -- UA_MUX12.SEL:
  decout_ctrl_word_ID(61 downto 61) <= 
	"1" when decoded_ADDI = '1' or decoded_ANDI = '1' or decoded_ARSI =
  	'1' or decoded_LB = '1' or decoded_LLSI = '1' or decoded_LSOI = '1' or
  ...
  decout_ctrl_word_ID(54 downto 54) <= 
	...
	"0";
  -- ALU.mode:
  decout_ctrl_word_ID(53 downto 49) <= 
	"10000" when decoded_LSOI = '1' or decoded_ORI = '1' else 
	"10010" when decoded_ANDI = '1' else 
	"01010" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ENEQ =
  	'1' or decoded_SUB = '1' or decoded_SUBI = '1' else
  ...
  decout_ctrl_word_ID(48 downto 48) <= 
	"1" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ENEQ = '1'
  ...
  decout_ctrl_word_ID(46 downto 46) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ANDI = '1'
  	or decoded_ARS = '1' or decoded_ARSI = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ENEQ = '1' or decoded_JPL = '1' or
  	decoded_JPRL = '1' or decoded_LLS = '1' or decoded_LLSI = '1' or
  	decoded_LSOI = '1' or decoded_MOD = '1' or decoded_ORI = '1' or
  ...
  decout_ctrl_word_ID(40 downto 40) <= 
	"1" when decoded_JPR = '1' or decoded_JPRL = '1' else 
	"0" when decoded_JP = '1' or decoded_JPL = '1' else 
	"0";
  -- UA_MUX05.SEL:
  decout_ctrl_word_ID(39 downto 37) <= 
	"110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"101" when decoded_ENEQ = '1' else 
	"100" when decoded_EEQ = '1' else 
	"011" when decoded_ELT = '1' else 
	"010" when decoded_ARS = '1' or decoded_ARSI = '1' or decoded_LLS =
  	'1' or decoded_LLSI = '1' else
	"001" when decoded_MOD = '1' else 
	"000" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ANDI =
  	'1' or decoded_LSOI = '1' or decoded_ORI = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' else
	"000";
  -- UA_MUX07.SEL:
  decout_ctrl_word_ID(36 downto 34) <= 
	"110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"101" when decoded_ENEQ = '1' else 
	"100" when decoded_EEQ = '1' else 
	"011" when decoded_ELT = '1' else 
  ...
  decout_ctrl_word_ID(33 downto 33) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ANDI = '1'
  	or decoded_ARS = '1' or decoded_ARSI = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ENEQ = '1' or decoded_LLS = '1' or
  	decoded_LLSI = '1' or decoded_LSOI = '1' or decoded_MOD = '1' or
  	decoded_ORI = '1' or decoded_SUB = '1' or decoded_SUBI = '1' else
	"0" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"0";
  -- UA_MUX13.SEL:
  decout_ctrl_word_ID(32 downto 30) <= 
	"110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"101" when decoded_ENEQ = '1' else 
	"100" when decoded_EEQ = '1' else 
	"011" when decoded_ELT = '1' else 
	...
	"000";
  -- UA_MUX15.SEL:
  decout_ctrl_word_ID(29 downto 27) <= 
	"110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"101" when decoded_ENEQ = '1' else 
	"100" when decoded_EEQ = '1' else 
	"011" when decoded_ELT = '1' else 
  ...
  decout_ctrl_word_ID(26 downto 26) <= 
	...
	"0";
  -- UA_MUX24.SEL:
  decout_ctrl_word_ID(25 downto 23) <= 
	"110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"101" when decoded_ENEQ = '1' else 
	"100" when decoded_EEQ = '1' else 
	"011" when decoded_ELT = '1' else 
  ...
  decout_ctrl_word_ID(13 downto 13) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ANDI = '1'
  	or decoded_ARS = '1' or decoded_ARSI = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ENEQ = '1' or decoded_JPL = '1' or
  	decoded_JPRL = '1' or decoded_LB = '1' or decoded_LLS = '1' or
  	decoded_LLSI = '1' or decoded_LSOI = '1' or decoded_LW = '1' or
  	decoded_MOD = '1' or decoded_ORI = '1' or decoded_SUB = '1' or
  	decoded_SUBI = '1' else
	"0";
  -- FWU0.fw2:
  ...
  decout_ctrl_word_ID(5 downto 5) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_ANDI = '1'
  	or decoded_ARS = '1' or decoded_ARSI = '1' or decoded_EEQ = '1' or
  	decoded_ELT = '1' or decoded_ENEQ = '1' or decoded_LB = '1' or
  	decoded_LLS = '1' or decoded_LLSI = '1' or decoded_LSOI = '1' or
  	decoded_LW = '1' or decoded_MOD = '1' or decoded_ORI = '1' or
  	decoded_SUB = '1' or decoded_SUBI = '1' else
	"0" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"0";
  -- UA_MUX14.SEL:
  ...
  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(53 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(13 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(72);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(71);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(70);
  decout_UA_MUX02_SEL <= decout_ctrl_word_ID(69 downto 68);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(67 downto 66);
  decout_UA_MUX04_SEL <= decout_ctrl_word_ID(65);
  decout_UA_MUX08_SEL <= decout_ctrl_word_ID(64 downto 63);
  decout_UA_MUX10_SEL <= decout_ctrl_word_ID(62);
  decout_UA_MUX12_SEL <= decout_ctrl_word_ID(61);
  decout_UA_MUX16_SEL <= decout_ctrl_word_ID(60);
  decout_UA_MUX18_SEL <= decout_ctrl_word_ID(59);
  decout_UA_MUX20_SEL <= decout_ctrl_word_ID(58);
  decout_UA_MUX22_SEL <= decout_ctrl_word_ID(57);
  decout_UA_MUX25_SEL <= decout_ctrl_word_ID(56 downto 55);
  decout_UA_MUX26_SEL <= decout_ctrl_word_ID(54);
  decout_ALU_mode <= decout_ctrl_word_EXE(53 downto 49);
  decout_ALU_cin <= decout_ctrl_word_EXE(48);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(47);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(46);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(45);
  decout_DIV_mode <= decout_ctrl_word_EXE(44);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(43 downto 42);
  decout_PC_load <= decout_ctrl_word_EXE(41);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(40);
  decout_UA_MUX05_SEL <= decout_ctrl_word_EXE(39 downto 37);
  decout_UA_MUX07_SEL <= decout_ctrl_word_EXE(36 downto 34);
  decout_UA_MUX09_SEL <= decout_ctrl_word_EXE(33);
  decout_UA_MUX13_SEL <= decout_ctrl_word_EXE(32 downto 30);
  decout_UA_MUX15_SEL <= decout_ctrl_word_EXE(29 downto 27);
  decout_UA_MUX17_SEL <= decout_ctrl_word_EXE(26);
  decout_UA_MUX24_SEL <= decout_ctrl_word_EXE(25 downto 23);
