...
{ 
  ...
  3,
  { 
    { "op_code0", 0, 22, 114737, "114737", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
...
{ 
  ...
  3,
  { 
    { "op_code0", 0, 22, 114738, "114738", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rs1", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rd", 27, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
  },
},
/*STEP4a*/
{ 
  "STEP4a", "STEP4a %rd , %rs1 , %rs2 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 1, "1", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 8, 129, "129", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code2", 14, 3, 7, "7", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
...
/*STEP4b*/
{ 
  "STEP4b", "STEP4b %rd , %rs1 , %rs2 , %rs3 ",
  32,
  6,
  { 
    { "op_code0", 0, 6, 61, "61", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "op_code1", 6, 6, 63, "63", "", E_INSN_FIELD_TYPE__OPCODE, brownie32_encode_opcode_field_type, brownie32_decode_opcode_field_type, 0},
    { "rd", 12, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs3", 17, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs2", 22, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
    { "rs1", 27, 5, 0, "0", "", E_INSN_FIELD_TYPE__REGBANK_GR, brownie32_encode_register_field_type, brownie32_decode_register_field_type, brownie32_parse_register_field_type},
  },
},
...
#define behavior_INIT__STEP2 \
int32_t rs1 = operands[0];\
int32_t rd = operands[1];\

#define behavior_INIT__STEP5 \
int32_t rs1 = operands[0];\
int32_t rd = operands[1];\

#define behavior_INIT__STEP4a \
int32_t rd = operands[0];\
int32_t rs2 = operands[1];\
int32_t rs1 = operands[2];\

#define behavior_INIT__STEP4b \
int32_t rd = operands[0];\
