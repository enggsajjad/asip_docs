...
m4_define(<<<<__RTL_TEMPLATES__>>>>,<<<<(define_insn "builtin_brownie32_STEP2"
[
(set (match_operand:SI 0 "brownie32_gr_regs_operand" "=d")
  (unspec:VOID [
    (match_operand:SI 1 "brownie32_gr_regs_operand" "d") ;; rs1
    ]  UNSPEC_BUILTIN_STEP2))
]
""
"STEP2 %0 , %1 "
[(set_attr "length" "4")
 (set_attr "insn_mnemonic" "STEP2")]
)

(define_insn "builtin_brownie32_STEP5"
[
(set (match_operand:SI 0 "brownie32_gr_regs_operand" "=d")
  (unspec:VOID [
    (match_operand:SI 1 "brownie32_gr_regs_operand" "d") ;; rs1
    ]  UNSPEC_BUILTIN_STEP5))
]
""
"STEP5 %0 , %1 "
[(set_attr "length" "4")
 (set_attr "insn_mnemonic" "STEP5")]
)

(define_insn "builtin_brownie32_STEP4a"
[
(set (match_operand:SI 0 "brownie32_gr_regs_operand" "=d")
  (unspec:VOID [
    (match_operand:SI 1 "brownie32_gr_regs_operand" "d") ;; rs1
    (match_operand:SI 2 "brownie32_gr_regs_operand" "d") ;; rs2
    ]  UNSPEC_BUILTIN_STEP4a))
]
""
"STEP4a %0 , %1 , %2 "
[(set_attr "length" "4")
 (set_attr "insn_mnemonic" "STEP4a")]
)

(define_insn "builtin_brownie32_STEP4b"
[
(set (match_operand:SI 0 "brownie32_gr_regs_operand" "=d")
  (unspec:VOID [
    (match_operand:SI 1 "brownie32_gr_regs_operand" "d") ;; rs1
    (match_operand:SI 2 "brownie32_gr_regs_operand" "d") ;; rs2
    (match_operand:SI 3 "brownie32_gr_regs_operand" "d") ;; rs3
    ]  UNSPEC_BUILTIN_STEP4b))
]
""
"STEP4b %0 , %1 , %2 , %3 "
[(set_attr "length" "4")
 (set_attr "insn_mnemonic" "STEP4b")]
)

>>>>)

m4_define(<<<<__INIT_BUILTINS__>>>>,<<<<tree ftype_STEP2 = build_function_type_list (integer_type_node, integer_type_node, NULL_TREE);
tree ftype_STEP5 = build_function_type_list (integer_type_node, integer_type_node, NULL_TREE);
tree ftype_STEP4a = build_function_type_list (integer_type_node, integer_type_node, integer_type_node, NULL_TREE);
tree ftype_STEP4b = build_function_type_list (integer_type_node, integer_type_node, integer_type_node, integer_type_node, NULL_TREE);

builtin_function ("__builtin_brownie32_STEP2", ftype_STEP2, CODE_FOR_builtin_brownie32_STEP2, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_STEP5", ftype_STEP5, CODE_FOR_builtin_brownie32_STEP5, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_STEP4a", ftype_STEP4a, CODE_FOR_builtin_brownie32_STEP4a, BUILT_IN_MD, NULL, NULL_TREE);
builtin_function ("__builtin_brownie32_STEP4b", ftype_STEP4b, CODE_FOR_builtin_brownie32_STEP4b, BUILT_IN_MD, NULL, NULL_TREE);
>>>>)

m4_define(<<<<__MD_CONSTANTS__>>>>,<<<<;; Constants used in RTL templates.
(define_constants
[
(UNSPEC_BUILTIN_STEP2 10000)
(UNSPEC_BUILTIN_STEP5 10001)
(UNSPEC_BUILTIN_STEP4a 10002)
(UNSPEC_BUILTIN_STEP4b 10003)
]
)
>>>>)

m4_define(<<<<__SCHEDULING__>>>>,<<<<(define_attr "insn_mnemonic"
  "STEP2,STEP5,STEP4a,STEP4b,unknown"
(const_string "unknown")
)

(define_insn_reservation "STEP2" 1
  (eq_attr "insn_mnemonic"  "STEP2")
  "nothing"
)

(define_insn_reservation "STEP5" 1
  (eq_attr "insn_mnemonic"  "STEP5")
  "nothing"
)

(define_insn_reservation "STEP4a" 1
  (eq_attr "insn_mnemonic"  "STEP4a")
  "nothing"
)

(define_insn_reservation "STEP4b" 1
  (eq_attr "insn_mnemonic"  "STEP4b")
  "nothing"
)
