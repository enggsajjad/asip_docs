...
architecture RTL of rtg_controller is
  ...
  end component rtg_register_w73;
  ...
  signal decoded_STEP2 : std_logic;
  signal decoded_STEP5 : std_logic;
  signal decoded_STEP4a : std_logic;
  signal decoded_STEP4b : std_logic;
  ...
  signal decout_ctrl_word_ID : std_logic_vector(98 downto 0);
  signal decout_ctrl_word_EXE : std_logic_vector(72 downto 0);
  signal decout_ctrl_word_in_EXE : std_logic_vector(72 downto 0);
...
begin
  ...
  decoded_EXHW <= 
	...
	'0';
  decoded_STEP2 <= 
	'1' when DATAIN_IR_DATA_OUT(21 downto 0) = "0000011100000000110001"
  	else
	'0';
  decoded_STEP5 <= 
	'1' when DATAIN_IR_DATA_OUT(21 downto 0) = "0000011100000000110010"
  	else
	'0';
  decoded_STEP4a <= 
	'1' when DATAIN_IR_DATA_OUT(16 downto 14) = "111" and
  	DATAIN_IR_DATA_OUT(13 downto 6) = "10000001" and DATAIN_IR_DATA_OUT(5
  	downto 0) = "000001" else
	'0';
  decoded_STEP4b <= 
	'1' when DATAIN_IR_DATA_OUT(11 downto 6) = "111111" and
  	DATAIN_IR_DATA_OUT(5 downto 0) = "111101" else
	'0';
  ...
  decout_ctrl_word_ID(95 downto 94) <= 
	...
	"00" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_SB = '1' or decoded_SH = '1' or decoded_STEP2 = '1' or
  ...
  decout_ctrl_word_ID(91 downto 91) <= 
	...
	"0";
  -- UA_MUX10.SEL:
  decout_ctrl_word_ID(90 downto 88) <= 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' or decoded_STEP2 =
  	'1' or decoded_STEP5 = '1' else
	...
	"000" when decoded_ADD = '1' or decoded_AND = '1' or decoded_ARS = '1'
  	...
  	decoded_NOR = '1' or decoded_OR = '1' or decoded_STEP4a = '1' or
  	decoded_STEP4b = '1' or decoded_SUB = '1' or decoded_XOR = '1' else
	"000";
  -- UA_MUX12.SEL:
  decout_ctrl_word_ID(87 downto 86) <= 
	"11" when decoded_STEP4b = '1' else 
	"10" when decoded_EXBW = '1' or decoded_EXHW = '1' or decoded_STEP2 =
  	'1' or decoded_STEP5 = '1' else
  ...
  decout_ctrl_word_ID(78 downto 77) <= 
	...
	"00";
  -- UA_MUX27.SEL:
  decout_ctrl_word_ID(76 downto 74) <= 
	"100" when decoded_EXBW = '1' or decoded_EXHW = '1' or decoded_STEP2 =
  	'1' or decoded_STEP5 = '1' else
	"011" when decoded_RETI = '1' else 
	"010" when decoded_JPR = '1' or decoded_JPRL = '1' or decoded_SB = '1'
  ...
  decout_ctrl_word_ID(73 downto 73) <= 
	...
	"0";
  -- ALU.mode:
  decout_ctrl_word_ID(72 downto 68) <= 
	"01000" when decoded_STEP4b = '1' else 
	...
	"01010" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU =
  	'1' or decoded_ENEQ = '1' or decoded_STEP2 = '1' or decoded_SUB = '1'
	...
	"01001" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_BRNZ =
  	...
  	= '1' or decoded_SH = '1' or decoded_STEP4a = '1' or decoded_SW = '1'
  	else
	"00000";
  -- ALU.cin:
  decout_ctrl_word_ID(67 downto 67) <= 
	"1" when decoded_EEQ = '1' or decoded_ELT = '1' or decoded_ELTU = '1'
  	or decoded_ENEQ = '1' or decoded_STEP2 = '1' or decoded_STEP4b = '1' or
  ...
  decout_ctrl_word_ID(65 downto 65) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_NAND = '1' or decoded_NOR = '1' or decoded_OR = '1' or
  	decoded_ORI = '1' or decoded_STEP2 = '1' or decoded_STEP4a = '1' or
  	decoded_STEP4b = '1' or decoded_STEP5 = '1' or decoded_SUB = '1' or
  ...
  decout_ctrl_word_ID(54 downto 53) <= 
	"10" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	= '1' or decoded_STEP2 = '1' or decoded_SUB = '1' or decoded_SUBI = '1'
  	or decoded_SW = '1' or decoded_XOR = '1' or decoded_XORI = '1' else
	"01" when decoded_STEP4b = '1' else 
	"00" when decoded_STEP4a = '1' else 
	"00";
  -- UA_MUX04.SEL:
  decout_ctrl_word_ID(52 downto 51) <= 
	"10" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_XOR = '1' or decoded_XORI = '1' else
	"01" when decoded_STEP4a = '1' else 
	"00" when decoded_STEP2 = '1' else 
	"00";
  -- UA_MUX07.SEL:
  decout_ctrl_word_ID(50 downto 47) <= 
	"1110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1101" when decoded_STEP4b = '1' else 
	"1100" when decoded_STEP5 = '1' else 
	"1011" when decoded_STEP2 = '1' else 
	...
	"0000" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND =
  	...
  	decoded_STEP4a = '1' or decoded_SUB = '1' or decoded_SUBI = '1' or
  	decoded_XOR = '1' or decoded_XORI = '1' else
	"0000";
  -- UA_MUX09.SEL:
  decout_ctrl_word_ID(46 downto 43) <= 
	"1110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1101" when decoded_STEP4b = '1' else 
	"1100" when decoded_STEP5 = '1' else 
	"1011" when decoded_STEP2 = '1' else 
  ...
  decout_ctrl_word_ID(42 downto 42) <= 
	"1" when decoded_ADD = '1' or decoded_ADDI = '1' or decoded_AND = '1'
  	...
  	decoded_OR = '1' or decoded_ORI = '1' or decoded_STEP2 = '1' or
  	decoded_STEP4a = '1' or decoded_STEP4b = '1' or decoded_STEP5 = '1' or
  ...
  decout_ctrl_word_ID(41 downto 38) <= 
	...
	"0000";
  -- UA_MUX17.SEL:
  decout_ctrl_word_ID(37 downto 34) <= 
	"1110" when decoded_JPL = '1' or decoded_JPRL = '1' else 
	"1101" when decoded_STEP4b = '1' else 
	"1100" when decoded_STEP5 = '1' else 
	"1011" when decoded_STEP2 = '1' else 
  ...
  decout_ctrl_word_ID(28 downto 28) <= 
	"1" when decoded_STEP4b = '1' else 
	"0" when decoded_STEP4a = '1' else 
	"0";
  -- UA_MUX30.SEL:
  ...
  decout_ctrl_word_in_EXE <= decout_ctrl_word_ID(72 downto 0);
  decout_ctrl_word_in_WB <= decout_ctrl_word_EXE(13 downto 0);
  decout_EXT16TO32_mode <= decout_ctrl_word_ID(98);
  decout_EXT26TO32_mode <= decout_ctrl_word_ID(97);
  decout_TRAP_HAND_REG_enb <= decout_ctrl_word_ID(96);
  decout_UA_MUX03_SEL <= decout_ctrl_word_ID(95 downto 94);
  decout_UA_MUX05_SEL <= decout_ctrl_word_ID(93 downto 92);
  decout_UA_MUX06_SEL <= decout_ctrl_word_ID(91);
  decout_UA_MUX10_SEL <= decout_ctrl_word_ID(90 downto 88);
  decout_UA_MUX12_SEL <= decout_ctrl_word_ID(87 downto 86);
  decout_UA_MUX14_SEL <= decout_ctrl_word_ID(85 downto 84);
  decout_UA_MUX18_SEL <= decout_ctrl_word_ID(83);
  decout_UA_MUX20_SEL <= decout_ctrl_word_ID(82 downto 81);
  decout_UA_MUX22_SEL <= decout_ctrl_word_ID(80 downto 79);
  decout_UA_MUX24_SEL <= decout_ctrl_word_ID(78 downto 77);
  decout_UA_MUX27_SEL <= decout_ctrl_word_ID(76 downto 74);
  decout_UA_MUX28_SEL <= decout_ctrl_word_ID(73);
  decout_ALU_mode <= decout_ctrl_word_EXE(72 downto 68);
  decout_ALU_cin <= decout_ctrl_word_EXE(67);
  decout_GPR_flag_enb <= decout_ctrl_word_EXE(66);
  decout_FWU0_fw1 <= decout_ctrl_word_EXE(65);
  decout_FWU1_fw1 <= decout_ctrl_word_EXE(64);
  decout_MUL_mode <= decout_ctrl_word_EXE(63);
  decout_DIV_mode <= decout_ctrl_word_EXE(62);
  decout_SFTvar_mode <= decout_ctrl_word_EXE(61 downto 60);
  decout_PC_load <= decout_ctrl_word_EXE(59);
  decout_GPR_status_enb <= decout_ctrl_word_EXE(58);
  decout_EXT8TO32_mode <= decout_ctrl_word_EXE(57);
  decout_EXT16TO32A_mode <= decout_ctrl_word_EXE(56);
  decout_UA_MUX00_SEL <= decout_ctrl_word_EXE(55);
  decout_UA_MUX02_SEL <= decout_ctrl_word_EXE(54 downto 53);
  decout_UA_MUX04_SEL <= decout_ctrl_word_EXE(52 downto 51);
  decout_UA_MUX07_SEL <= decout_ctrl_word_EXE(50 downto 47);
  decout_UA_MUX09_SEL <= decout_ctrl_word_EXE(46 downto 43);
  decout_UA_MUX11_SEL <= decout_ctrl_word_EXE(42);
  decout_UA_MUX15_SEL <= decout_ctrl_word_EXE(41 downto 38);
  decout_UA_MUX17_SEL <= decout_ctrl_word_EXE(37 downto 34);
  decout_UA_MUX19_SEL <= decout_ctrl_word_EXE(33);
  decout_UA_MUX26_SEL <= decout_ctrl_word_EXE(32 downto 29);
  decout_UA_MUX29_SEL <= decout_ctrl_word_EXE(28);
  decout_UA_MUX30_SEL <= decout_ctrl_word_EXE(27);
  decout_UA_MUX31_SEL <= decout_ctrl_word_EXE(26);
  decout_UA_MUX32_SEL <= decout_ctrl_word_EXE(25);
  decout_UA_MUX33_SEL <= decout_ctrl_word_EXE(24);
