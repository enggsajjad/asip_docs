...
-- Generated by ASIP Meister 2.3 on 2019/01/30 15:36:04 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal uf_newadder1_result : std_logic_vector(31 downto 0);
  signal ua_altsel08_dout : std_logic_vector(31 downto 0);
  signal uf_newadder1_cout : std_logic;
  signal concat_06 : std_logic_vector(31 downto 0);
  signal uf_newadder2_result : std_logic_vector(31 downto 0);
  ...
  signal ua_altsel09_dout : std_logic_vector(31 downto 0);
  signal const_b1 : std_logic;
  signal saved_pc_signal : std_logic_vector(31 downto 0);
  signal bitand_17 : std_logic_vector(31 downto 0);
  ...
  signal ua_altsel00_dout : std_logic;
  ...
  signal bitpos30_00 : std_logic;
  signal bitpos29_00 : std_logic;
  signal bitor_02 : std_logic;
  signal bitpos28_00 : std_logic;
  signal bitor_03 : std_logic;
  signal bitpos27_00 : std_logic;
  signal bitor_04 : std_logic;
  signal bitpos26_00 : std_logic;
  signal bitor_05 : std_logic;
  signal bitpos25_00 : std_logic;
  signal bitor_06 : std_logic;
  signal bitpos24_00 : std_logic;
  signal bitor_07 : std_logic;
  signal bitpos23_00 : std_logic;
  signal bitor_08 : std_logic;
  signal bitpos22_00 : std_logic;
  signal bitor_09 : std_logic;
  signal bitpos21_00 : std_logic;
  signal bitor_10 : std_logic;
  signal bitpos20_00 : std_logic;
  signal bitor_11 : std_logic;
  signal bitpos19_00 : std_logic;
  signal bitor_12 : std_logic;
  signal bitpos18_00 : std_logic;
  signal bitor_13 : std_logic;
  signal bitpos17_00 : std_logic;
  signal bitor_14 : std_logic;
  signal bitpos16_00 : std_logic;
  signal bitor_15 : std_logic;
  signal bitpos15_00 : std_logic;
  ...
  signal bitand_05 : std_logic;
  signal bitand_06 : std_logic;
  signal bitand_07 : std_logic;
  signal bitand_08 : std_logic;
  signal bitand_09 : std_logic;
  signal bitand_10 : std_logic;
  signal bitand_11 : std_logic;
  signal bitand_12 : std_logic;
  signal bitand_13 : std_logic;
  signal bitor_16 : std_logic;
  signal ua_altsel03_dout : std_logic;
  signal bitand_15 : std_logic;
  signal const_32h00007fff : std_logic_vector(31 downto 0);
  signal bitand_14 : std_logic;
  signal bitand_16 : std_logic;
  signal ua_altsel04_dout : std_logic_vector(31 downto 0);
  signal const_32hffff8000 : std_logic_vector(31 downto 0);
  signal bitpos14_00 : std_logic;
  signal bitpos13_00 : std_logic;
  signal bitpos12_00 : std_logic;
  signal bitpos11_00 : std_logic;
  signal bitpos10_00 : std_logic;
  signal bitpos9_00 : std_logic;
  signal bitpos8_00 : std_logic;
  signal bitpos7_00 : std_logic;
  signal bitpos6_00 : std_logic;
  signal bitpos5_00 : std_logic;
  signal bitpos4_00 : std_logic;
  ...
  signal ua_mux33_dout : std_logic;
  ...
  signal ua_mux37_dout : std_logic_vector(4 downto 0);
...
begin
  ...
  UF_GPR : fhm_browregfile_w32
    port map (
      ...
      w_sel0 => ua_mux37_dout, 
      data_in0 => ua_mux38_dout, 
      r_sel0 => ua_mux27_dout, 
      r_sel1 => ua_mux28_dout, 
      r_sel2 => bitrange21to17_00, 
      r_sel3 => unused_05, 
  ...
  UF_newADDER1 : fhm_adder_w32
    port map (
      a => ua_mux29_dout, 
      b => ua_mux30_dout, 
      cin => const_b0, 
      result => uf_newadder1_result, 
      cout => uf_newadder1_cout
    );

  UF_newADDER2 : fhm_adder_w32
    port map (
      a => ua_mux31_dout, 
      b => ua_mux32_dout, 
      cin => ua_mux33_dout, 
      result => uf_newadder2_result, 
      cout => unused_09
    );
  ...
  UA_ALTSEL08 : rtg_mux2to1_w32
    port map (
      SEL => bitpos2_02, 
      DIN0 => const_32h00000000, 
      DIN1 => concat_09, 
      DOUT => ua_altsel08_dout
    );

  UA_ALTSEL09 : rtg_mux2to1_w32
    port map (
      SEL => bitpos0_00, 
      DIN0 => uf_newadder1_result, 
      DIN1 => uf_newadder2_result, 
      DOUT => ua_altsel09_dout
    );
  ...
  UA_MUX07 : rtg_mux15to1_w32
    port map (
      ...
      DIN11 => ua_altsel02_dout, 
      DIN12 => ua_altsel05_dout, 
      DIN13 => ua_altsel09_dout, 
  ...
  UA_MUX32 : rtg_mux2to1_w32
    port map (
      SEL => ua_mux32_sel, 
      DIN0 => ua_altsel08_dout, 
      DIN1 => uf_alu_result, 
      DOUT => ua_mux32_dout
    );

  UA_MUX33 : rtg_mux2to1_w1
    port map (
      SEL => ua_mux33_sel, 
      DIN0 => uf_newadder1_cout, 
      DIN1 => const_b0, 
      DOUT => ua_mux33_dout
    );
  ...
  bitpos31_00 <= ua_preg02_dout(31);
  const_b1 <= '1';
  const_32h00000000 <= "00000000000000000000000000000000";
  bitpos30_00 <= ua_preg02_dout(30);
  bitpos29_00 <= ua_preg02_dout(29);
  bitpos28_00 <= ua_preg02_dout(28);
  bitpos27_00 <= ua_preg02_dout(27);
  bitpos26_00 <= ua_preg02_dout(26);
  bitpos25_00 <= ua_preg02_dout(25);
  bitpos24_00 <= ua_preg02_dout(24);
  bitpos23_00 <= ua_preg02_dout(23);
  bitpos22_00 <= ua_preg02_dout(22);
  bitpos21_00 <= ua_preg02_dout(21);
  bitpos20_00 <= ua_preg02_dout(20);
  bitpos19_00 <= ua_preg02_dout(19);
  bitpos18_00 <= ua_preg02_dout(18);
  bitpos17_00 <= ua_preg02_dout(17);
  bitpos16_00 <= ua_preg02_dout(16);
  bitpos15_00 <= ua_preg02_dout(15);
  bitor_02 <= bitpos30_00 or bitpos29_00;
  bitor_03 <= bitor_02 or bitpos28_00;
  bitor_04 <= bitor_03 or bitpos27_00;
  bitor_05 <= bitor_04 or bitpos26_00;
  bitor_06 <= bitor_05 or bitpos25_00;
  bitor_07 <= bitor_06 or bitpos24_00;
  bitor_08 <= bitor_07 or bitpos23_00;
  bitor_09 <= bitor_08 or bitpos22_00;
  bitor_10 <= bitor_09 or bitpos21_00;
  bitor_11 <= bitor_10 or bitpos20_00;
  bitor_12 <= bitor_11 or bitpos19_00;
  bitor_13 <= bitor_12 or bitpos18_00;
  bitor_14 <= bitor_13 or bitpos17_00;
  bitor_15 <= bitor_14 or bitpos16_00;
  bitor_16 <= bitor_15 or bitpos15_00;
  bitand_00 <= bitpos30_00 and bitpos29_00;
  bitand_01 <= bitand_00 and bitpos28_00;
  bitand_02 <= bitand_01 and bitpos27_00;
  bitand_03 <= bitand_02 and bitpos26_00;
  bitand_04 <= bitand_03 and bitpos25_00;
  bitand_05 <= bitand_04 and bitpos24_00;
  bitand_06 <= bitand_05 and bitpos23_00;
  bitand_07 <= bitand_06 and bitpos22_00;
  bitand_08 <= bitand_07 and bitpos21_00;
  bitand_09 <= bitand_08 and bitpos20_00;
  bitand_10 <= bitand_09 and bitpos19_00;
  bitand_11 <= bitand_10 and bitpos18_00;
  bitand_12 <= bitand_11 and bitpos17_00;
  bitand_13 <= bitand_12 and bitpos16_00;
  bitand_14 <= bitand_13 and bitpos15_00;
  const_32hffff8000 <= "11111111111111111000000000000000";
  const_32h00007fff <= "00000000000000000111111111111111";
  bitand_15 <= bitor_16 and ua_altsel03_dout;
  bitand_16 <= bitand_14 and bitpos31_00;
  bitpos14_00 <= ua_preg02_dout(14);
  bitpos13_00 <= ua_preg02_dout(13);
  bitpos12_00 <= ua_preg02_dout(12);
  bitpos11_00 <= ua_preg02_dout(11);
  bitpos10_00 <= ua_preg02_dout(10);
  bitpos9_00 <= ua_preg02_dout(9);
  bitpos8_00 <= ua_preg02_dout(8);
  bitpos7_00 <= ua_preg02_dout(7);
  bitpos6_00 <= ua_preg02_dout(6);
  bitpos5_00 <= ua_preg02_dout(5);
  bitpos4_00 <= ua_preg02_dout(4);
  bitpos3_01 <= ua_preg02_dout(3);
  concat_06 <= const_b0 & const_b0 & const_b0 & bitpos31_00 &
  	bitpos30_00 & bitpos29_00 & bitpos28_00 & bitpos27_00 & bitpos26_00 &
  	bitpos25_00 & bitpos24_00 & bitpos23_00 & bitpos22_00 & bitpos21_00 &
  	bitpos20_00 & bitpos19_00 & bitpos18_00 & bitpos17_00 & bitpos16_00 &
  	bitpos15_00 & bitpos14_00 & bitpos13_00 & bitpos12_00 & bitpos11_00 &
  	bitpos10_00 & bitpos9_00 & bitpos8_00 & bitpos7_00 & bitpos6_00 &
  	bitpos5_00 & bitpos4_00 & bitpos3_01;
  bitpos0_00 <= ua_preg03_dout(0);
  bitpos2_01 <= ua_preg02_dout(2);
  concat_07 <= const_b0 & const_b0 & bitpos31_00 & bitpos30_00 &
  	bitpos29_00 & bitpos28_00 & bitpos27_00 & bitpos26_00 & bitpos25_00 &
  	bitpos24_00 & bitpos23_00 & bitpos22_00 & bitpos21_00 & bitpos20_00 &
  	bitpos19_00 & bitpos18_00 & bitpos17_00 & bitpos16_00 & bitpos15_00 &
  	bitpos14_00 & bitpos13_00 & bitpos12_00 & bitpos11_00 & bitpos10_00 &
  	bitpos9_00 & bitpos8_00 & bitpos7_00 & bitpos6_00 & bitpos5_00 &
  	bitpos4_00 & bitpos3_01 & bitpos2_01;
  bitpos1_00 <= ua_preg03_dout(1);
  bitpos1_01 <= ua_preg02_dout(1);
  concat_08 <= const_b0 & bitpos31_00 & bitpos30_00 & bitpos29_00 &
  	bitpos28_00 & bitpos27_00 & bitpos26_00 & bitpos25_00 & bitpos24_00 &
  	bitpos23_00 & bitpos22_00 & bitpos21_00 & bitpos20_00 & bitpos19_00 &
  	bitpos18_00 & bitpos17_00 & bitpos16_00 & bitpos15_00 & bitpos14_00 &
  	bitpos13_00 & bitpos12_00 & bitpos11_00 & bitpos10_00 & bitpos9_00 &
  	bitpos8_00 & bitpos7_00 & bitpos6_00 & bitpos5_00 & bitpos4_00 &
  	bitpos3_01 & bitpos2_01 & bitpos1_01;
  bitpos2_02 <= ua_preg03_dout(2);
  bitpos0_01 <= ua_preg02_dout(0);
  concat_09 <= bitpos31_00 & bitpos30_00 & bitpos29_00 & bitpos28_00 &
  	bitpos27_00 & bitpos26_00 & bitpos25_00 & bitpos24_00 & bitpos23_00 &
  	bitpos22_00 & bitpos21_00 & bitpos20_00 & bitpos19_00 & bitpos18_00 &
  	bitpos17_00 & bitpos16_00 & bitpos15_00 & bitpos14_00 & bitpos13_00 &
  	bitpos12_00 & bitpos11_00 & bitpos10_00 & bitpos9_00 & bitpos8_00 &
  	bitpos7_00 & bitpos6_00 & bitpos5_00 & bitpos4_00 & bitpos3_01 &
  	bitpos2_01 & bitpos1_01 & bitpos0_01;
  bitnot_02 <= not ua_preg02_dout;
  ...
  bitand_17 <= uf_dummy_streg_data_out and const_32hffffbcff;
