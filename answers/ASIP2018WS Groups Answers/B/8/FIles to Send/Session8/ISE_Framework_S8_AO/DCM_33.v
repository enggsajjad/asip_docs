...
module DCM_33(CLKIN_IN, 
   ...
   DCM_ADV #( .CLK_FEEDBACK("1X"), .CLKDV_DIVIDE(2.0), .CLKFX_DIVIDE(1), 
         ...
         .CLKIN_PERIOD(30.303), .CLKOUT_PHASE_SHIFT("NONE"), 
   ...
   PLL_ADV #( .BANDWIDTH("OPTIMIZED"), .CLKIN1_PERIOD(30.303), 
         .CLKIN2_PERIOD(10.000), .CLKOUT0_DIVIDE(13), .CLKOUT1_DIVIDE(26), 
         .CLKOUT0_PHASE(0.000), .CLKOUT1_PHASE(0.000), 
         .CLKOUT0_DUTY_CYCLE(0.500), .CLKOUT1_DUTY_CYCLE(0.500), 
         .COMPENSATION("DCM2PLL"), .DIVCLK_DIVIDE(1), .CLKFBOUT_MULT(13), 
