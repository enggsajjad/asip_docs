...
-- Generated by ASIP Meister 2.3 on 2019/01/23 13:24:57 
----------------------------------------------------------------------
...
architecture RTL of BrownieSTD32 is
  ...
  signal ua_mux05_sel : std_logic_vector(2 downto 0);
  ...
  signal ua_mux13_sel : std_logic_vector(2 downto 0);
  ...
  signal ua_mux24_sel : std_logic_vector(2 downto 0);
  ...
  signal unused_07 : std_logic_vector(7 downto 0);
  signal unused_08 : std_logic_vector(31 downto 0);
  signal unused_09 : std_logic;
  signal unused_10 : std_logic;
  signal unused_11 : std_logic;
  signal unused_12 : std_logic;
  signal unused_13 : std_logic_vector(15 downto 0);
...
begin
  ...
  UA_MUX05 : rtg_mux7to1_w32
    port map (
      SEL => ua_mux05_sel, 
      DIN0 => uf_alu_result, 
      DIN1 => uf_div_r, 
      DIN2 => uf_sftvar_data_out, 
      DIN3 => concat_01, 
      DIN4 => concat_02, 
      DIN5 => concat_03, 
      DIN6 => ua_preg00_dout, 
  ...
  concat_02 <= const_31h00000000 & bitpos2_00;
  concat_03 <= const_31h00000000 & bitnot_00;
  ...
  concat_04 <= bitrange15to0_00 & const_16h0000;
  cmpeq_02 <= 
